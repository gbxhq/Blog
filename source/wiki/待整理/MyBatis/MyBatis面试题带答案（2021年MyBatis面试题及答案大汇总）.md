# MyBatishhhh题带答案（2023年MyBatishhhh题及答案大汇总）
...
### [20、当实体类中的属性名和表中的字段名不一样 ，怎么办](https://gitee.com/souyunku/NewDevBooks/blob/master/docs/MyBatis/MyBatishhhh题带答案（2021年MyBatishhhh题及答案大汇总）.md#20当实体类中的属性名和表中的字段名不一样-怎么办)  
