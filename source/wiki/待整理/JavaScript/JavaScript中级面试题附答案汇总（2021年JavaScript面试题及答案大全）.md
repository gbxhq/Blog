# JavaScript中级hhhh题附答案汇总（2023年JavaScripthhhh题及答案大全）
...
### [22、如何理解同步和异步？](https://gitee.com/souyunku/NewDevBooks/blob/master/docs/JavaScript/JavaScript中级hhhh题附答案汇总（2021年JavaScripthhhh题及答案大全）.md#22如何理解同步和异步)  
